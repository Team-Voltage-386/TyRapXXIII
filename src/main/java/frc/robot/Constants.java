...
public final class Constants {
  ...
  public static class PhotonVisionConstants{
    ...
    public static FieldTag at1=new FieldTag(1, 610.77, 42.19, 18.22,true,180);
    public static FieldTag at2=new FieldTag(2, 610.77, 108.19, 18.22,true,180);
    public static FieldTag at3=new FieldTag(3, 610.77, 174.19, 18.22,true,180);
    public static FieldTag at4=new FieldTag(4, 636.96, 265.74, 27.38,false,180);
    public static FieldTag at5=new FieldTag(5, 14.25, 265.74, 27.38,true,0);
    public static FieldTag at6=new FieldTag(6, 40.45, 174.19, 18.22,true,0);
    public static FieldTag at7=new FieldTag(7, 40.45, 108.19, 18.22,true,0);
    public static FieldTag at8=new FieldTag(8, 40.45, 42.19, 18.22,false,0);
