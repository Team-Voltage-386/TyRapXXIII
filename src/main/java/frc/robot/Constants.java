...
public final class Constants {
    ...
    public static final class LimelightConstants {
        public static final double kLimelightHeightMeters = 1.27; // estimated; should be measured from camera lens
        public static final double kLimelightDegreesFromVertical = 30.0; // estimated; angle of lens from vertical
    }
