...
public class Limelight extends SubsystemBase {
  ...
  /**
   * 
   * @return bot pose as double array length 6, position xyz and rotation xyz
   */
  ...
  /**
   * 
   * @param cropValues four doubles, -1 to 1; {x,x,y,y}
   */
  public void setCropCamera(double[] cropValues) {
    NetworkTableInstance.getDefault().getTable("limelight").getEntry("crop").setDoubleArray(cropValues);
  }

  public void clearCropCamera() {
    setCropCamera(new double[] { -1, 1, -1, 1 });
  }

  /**
   * 
   * @return if apriltag mode and if april tag is visible
   */
